...
TRAJECTORY_BUILDER_2D = {
  ...
  ceres_scan_matcher = {
    ...
    rotation_weight = 5.,  --40 // 23.12.23 final drive : successed 2m 34s
    -- rotation_weight = 10.,  --40 // final fixed value but not tested
    ceres_solver_options = {
      use_nonmonotonic_steps = false,
...
--@ 다 없이 그냥 last.bag best lua파일로 하면 직선 구간에서 빠르게 localization 매칭이 안되서 틀어짐
--! imu 센서의 그래비티 성분을 어떻게든 없애는게 좋을 듯
